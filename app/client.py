...
def main():
    ...
    try:
        ...
        if args.generation_length is None:
            ...
            base_log_dir = f"experiments-AE5/realtime/baseline/interval_{args.generation_interval_ticks}_gen_frame_{args.generation_length_per_request}/prompt_{args.injection_length}_gen_{args.generation_length}"
